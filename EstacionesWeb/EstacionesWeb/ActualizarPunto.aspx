<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ActualizarPunto.aspx.cs" Inherits="EstacionesWeb.ActualizarPunto" %>
     ...
     <div class="col-5 col-md-6 col-lg-4 mx-auto">
            <div class="card">
                <div class="card-header text-center bg-info text-dark">
                    <h3 class="p-2">Actualizar Punto de Carga</h3>
                </div>
                <div class="card-body">
